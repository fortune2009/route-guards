...
class AppRouter extends _i5.RootStackRouter {
  ...
  final Map<String, _i5.PageFactory> pagesMap = {
    ...
    ProductScreenRoute.name: (routeData) {
      return _i5.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i7.ProductScreen());
    },
    AddProductsRoute.name: (routeData) {
      return _i5.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i8.AddProductsRoute());
    }
  };
  ...
  List<_i5.RouteConfig> get routes => [
        ...
        _i5.RouteConfig(DashboardRoute.name, path: '/dashboard', guards: [
          ...
          _i5.RouteConfig(ProductsRoute.name,
              ...
              children: [
                _i5.RouteConfig(ProductScreenRoute.name,
...
class ProductScreenRoute extends _i5.PageRouteInfo<void> {
  const ProductScreenRoute() : super(ProductScreenRoute.name, path: '');

  static const String name = 'ProductScreenRoute';
}

/// generated route for
/// [_i8.AddProductsRoute]
